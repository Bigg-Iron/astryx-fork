import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{l as r,n as i,t as a,u as o}from"./themeProps-_oSbOSxB.js";import{_ as s,t as c,y as l}from"./utils-B_QrR_t3.js";import{t as u}from"./jsx-runtime-DqZldVDK.js";import{n as d,t as f}from"./useOverflow-BKKBYm-1.js";function p({children:e,gap:t=2,minVisibleItems:n=0,collapseFrom:r=`end`,behavior:a=`observeSelf`,overflowRenderer:c,xstyle:u,className:f,style:p,ref:y,...b}){let x=m.Children.toArray(e),S=x.length,C=v[t],w=a===`observeParent`,{containerRef:T,measureRef:E,visibleCount:D,hasOverflow:O}=d(S,{gap:C,minVisibleItems:n,collapseFrom:r,behavior:a}),k=x.map((e,t)=>({child:e,index:t})),A,j;r===`end`?(A=k.slice(0,D),j=k.slice(D)):(A=k.slice(S-D),j=k.slice(0,S-D));let M=c?.(k);return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsxs)(`div`,{ref:E,"aria-hidden":`true`,inert:!0,...o(g.measureContainer,_[t]),children:[x,M!=null&&(0,h.jsx)(`div`,{className:`astryx3nfvp2`,children:M})]}),(0,h.jsxs)(`div`,{ref:s(y,T),...l(i(`overflow-list`),o(g.container,_[t],w&&O&&g.fillParent,u),f,p),...b,children:[r===`start`&&O&&c?.(j),A.map(({child:e})=>e),r===`end`&&O&&c?.(j)]})]})}var m,h,g,_,v,y=e((()=>{m=t(n(),1),r(),c(),f(),a(),h=u(),g={container:{k1xSpc:`astryx78zum5`,kGNEyG:`astryx6s0dn4`,kVQacm:`astryxb3r6kr`,khDVqt:`astryxuxw1ft`,k7Eaqz:`astryxeuugli`,$$css:!0},fillParent:{kzqmXN:`astryxh8yej3`,$$css:!0},measureContainer:{kVAEAm:`astryx10l6tqk`,k33iCy:`astryxlshs6z`,kZKoxP:`astryxqtp20y`,kVQacm:`astryxb3r6kr`,k1xSpc:`astryx78zum5`,kGNEyG:`astryx6s0dn4`,khDVqt:`astryxuxw1ft`,kfzvcC:`astryx47corl`,$$css:!0}},_={0:{kOIVth:`astryxsn7fz1`,khm7nJ:null,k1C7PZ:null,$$css:!0},1:{kOIVth:`astryxzye2dw`,khm7nJ:null,k1C7PZ:null,$$css:!0},2:{kOIVth:`astryx1txdalj`,khm7nJ:null,k1C7PZ:null,$$css:!0},3:{kOIVth:`astryxjcht0a`,khm7nJ:null,k1C7PZ:null,$$css:!0},4:{kOIVth:`astryx18g69wz`,khm7nJ:null,k1C7PZ:null,$$css:!0},5:{kOIVth:`astryx9mgr7n`,khm7nJ:null,k1C7PZ:null,$$css:!0},6:{kOIVth:`astryx1qh66ti`,khm7nJ:null,k1C7PZ:null,$$css:!0},8:{kOIVth:`astryx4t41sb`,khm7nJ:null,k1C7PZ:null,$$css:!0},10:{kOIVth:`astryx3hoi3v`,khm7nJ:null,k1C7PZ:null,$$css:!0},"0.5":{kOIVth:`astryx1lsbc85`,khm7nJ:null,k1C7PZ:null,$$css:!0},"1.5":{kOIVth:`astryx1s4dlld`,khm7nJ:null,k1C7PZ:null,$$css:!0}},v={0:0,.5:2,1:4,1.5:6,2:8,3:12,4:16,5:20,6:24,8:32,10:40},p.displayName=`OverflowList`,p.__docgenInfo={description:`A horizontal list that hides items that don't fit and shows an overflow indicator.
